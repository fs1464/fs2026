  ...
  return (
    <SafeAreaView style={styles.safe}>
      <View style={styles.body}>
        <Text style={styles.title}>Welcome to Nearly</Text>
        <Text style={styles.body_}>Connect with your neighborhood.</Text>
...
const styles = StyleSheet.create({
  ...
  title: { fontFamily: fonts.headline, fontSize: 24, color: colors.onSurface },
