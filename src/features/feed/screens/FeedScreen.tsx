...
function ReelCard({ reel }: { reel: Reel }) {
  return (
    <View style={styles.card}>
      <Image source={{ uri: reel.image }} style={styles.media} resizeMode="cover" />
      ...
      <View style={styles.rightRail}>
        <Action icon={<Heart size={24} color="#fff" strokeWidth={2} />} label={reel.likes} />
        <Action icon={<MessageCircle size={24} color="#fff" strokeWidth={2} />} label={reel.comments} />
        <Action icon={<Send size={24} color="#fff" strokeWidth={2} />} label="Share" />
      </View>
      <View style={styles.bottomBar}>
        <View style={styles.authorRow}>
          <Image source={{ uri: reel.avatar }} style={styles.authorAvatar} />
          <View style={{ flex: 1 }}>
            <Text style={styles.authorName}>{reel.author}</Text>
            <Text style={styles.authorLoc}>{reel.location}</Text>
          </View>
